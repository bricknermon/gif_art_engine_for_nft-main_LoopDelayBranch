...
{
    string systemCall = "ffmpeg -i " + pathMp4 + " -vf \"fps=15,scale=" + to_string(scale) + ":-1:flags=lanczos,split[s0][s1];[s0]palettegen[p];[s1][p]paletteuse\" -loop 0 -final_delay 50 " + pathGif + " -y";
